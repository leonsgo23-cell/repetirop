...
const SECTIONS_UK = [
  {
    icon: '🎮',
    title: 'Як проходить урок?',
    color: 'from-indigo-500 to-purple-600',
    items: [
      'Оріс сам починає урок — вітає і одразу дає перше завдання',
      'Ти відповідаєш у чаті — пишеш відповідь і натискаєш Enter або кнопку ➤',
      'Оріс перевіряє відповідь: правильна — отримуєш ⭐ XP, неправильна — допомагає розібратися',
      'Всього 5–7 завдань зростаючої складності: від легкого до «Босс-рівня»',
      'Наприкінці теми Оріс пише 🏆 РІВЕНЬ ПІДВИЩЕНО! — тема вважається пройденою',
    ],
  },
  {
    icon: '⏱️',
    title: 'Скільки триває заняття?',
    color: 'from-blue-500 to-cyan-600',
    items: [
      '15–20 хвилин на одну тему — ідеально для концентрації дитини',
      'Можна вийти в будь-який момент — прогрес XP зберігається автоматично',
      'Якщо втомився — просто закрий вкладку і повернись пізніше',
      'Немає таймера і тиску — займайся у своєму темпі',
    ],
  },
  {
    icon: '📅',
    title: 'Як часто займатися?',
    color: 'from-green-500 to-teal-600',
    items: [
      'Рекомендуємо: 3–5 разів на тиждень по 15–20 хвилин',
      'Щоденні заняття дають серію 🔥 і бонусні досягнення',
      'Краще короткі регулярні заняття, ніж рідкі довгі',
      '1 клас: 1–2 теми на тиждень | 5–9 клас: 2–3 теми на тиждень',
      'У період контрольних — повторюй пройдені теми для закріплення',
    ],
  },
  {
    icon: '🔀',
    title: 'Як переходити від уроку до уроку?',
    color: 'from-orange-500 to-amber-600',
    items: [
      '1. Натисни «← До тем» у верхньому лівому куті уроку',
      '2. Обери наступну тему зі списку — теми йдуть за порядком складності',
      '3. Пройдені теми позначені галочкою ✓',
      '4. Немає обмежень — можна переходити до будь-якої теми в будь-який момент',
      '5. Хочеш повторити пройдене? Просто зайди в тему знову',
    ],
  },
  {
    icon: '📚',
    ...
    color: 'from-pink-500 to-rose-600',
    items: [
      'Математика: відмінно для логіки та лічби — починай з тем свого класу',
      'Англійська: словниковий запас, граматика — Оріс адаптує рівень під твій клас',
      'Займайся спочатку тим предметом, який дається важче — свіжий мозок краще засвоює',
      'Чергуй математику та англійську — так не набридає',
    ],
  },
  {
    icon: '👪',
    ...
    color: 'from-violet-500 to-purple-600',
    items: [
      'Оріс — не замінник вчителя, а додаткова практика вдома',
      'Стежте за розділом «Досягнення» на головному екрані — це покаже прогрес',
      'XP і рівні мотивують дитину займатися самостійно',
      'Програма суворо відповідає стандартам МОН Латвії (Skola2030)',
      'Якщо дитина застрягла — вона може написати «не розумію» і Оріс пояснить інакше',
      'Оптимальний вік для самостійного використання: 8–15 років',
    ],
  },
];
...
export default function Guide() {
  ...
  const sections = lang === 'lv' ? SECTIONS_LV : lang === 'uk' ? SECTIONS_UK : SECTIONS_RU;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {lang === 'lv' ? 'Kā darbojas Oris?' : lang === 'uk' ? 'Як працює Оріс?' : 'Как работает Орис?'}
        </h1>
        <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.85rem', margin: 0 }}>
          {lang === 'lv' ? 'Izlasi — un viss kļūs skaidrs!' : lang === 'uk' ? 'Прочитай — і одразу все стане зрозуміло!' : 'Прочитай — и сразу всё станет понятно!'}
        </p>
      </div>
      ...
      >
        ...
        >
          {lang === 'lv' ? '🚀 Skaidrs, sākam!' : lang === 'uk' ? '🚀 Зрозуміло, починаємо!' : '🚀 Понятно, начинаем!'}
        </motion.button>
      </div>
    </div>
  );
