...
const T = {
  lv: {
    ...
    what_tag:'Kas tas ir',
    what_title:'Viedais tiešsaistes repetitors tavam bērnam — vienmēr klāt',
    what_sub:'SmartSkola nav vienkāršs AI čats. Tā ir pilnvērtīga mācību sistēma pēc Latvijas skolu programmas, kas darbojas kā personīgais tiešsaistes repetitors: skaidro, pārbauda, atceras progresu.',
    wp1h:'Tiešsaistes repetitors uz MI bāzes skaidro — kā dzīvs repetitors', wp1p:'Uzdod jautājumus, skaidro pa soļiem, izvēlas piemērus tieši šim bērnam. Ne no mācību grāmatas — no dzīves.',
    wp2h:'Palīdz ar mājas darbiem', wp2p:'Bērns raksta savu uzdevumu — tiešsaistes repetitors Oris skaidro kā atrisināt, ne tikai dod atbildi. Izpratne paliek.',
    ...
    ba2n:'Tiešsaistes repetitors izskaidroja citādi — ar kartītēm. Nedēļas laikā tēma apgūta',
    ...
    g4h:'Izmēģinājuma periods', g4p:'14 dienas bez maksas — pārliecinieties paši pirms maksāšanas',
    meth_tag:'Mācību sistēma', meth_title:'SmartSkola metodika',
    meth_sub:'Ne tikai AI čats. Pilnvērtīga tiešsaistes repetitora sistēma, kas ved bērnu no nezināšanas līdz rezultātam — soli pa solim.',
    ...
    st3h:'Izskaidrojums pa soļiem', st3p:'Tiešsaistes repetitors skaidro tā, kā saprot tieši šis bērns — ar dzīves piemēriem, bez garlaicīgām grāmatām.',
    ...
    trial_p:'Pirmās 14 dienas — bez maksas. Pirmās stundas, mājas darbu palīdzība un pilna piekļuve visiem priekšmetiem. Jūs redzēsiet rezultātu pirms maksāšanas.',
    ...
    trial_ph:'jūsu@epasts.lv', trial_btn:'Izmēģināt 14 dienas bez maksas →', trial_note:'Bez kartes · Atcelšana jebkurā laikā · Dati aizsargāti',
  ...
  ru: {
    ...
    what_title:'Умный онлайн репетитор для вашего ребёнка — всегда рядом',
    what_sub:'SmartSkola — это не просто онлайн репетитор на базе ИИ. Это полноценная система обучения по школьной программе Латвии, которая работает как персональный онлайн репетитор: объясняет, проверяет, запоминает прогресс.',
    wp1h:'Онлайн репетитор на базе ИИ объясняет — как живой репетитор', wp1p:'Задаёт вопросы, объясняет шагами, подбирает примеры под конкретного ребёнка. Не из учебника — из жизни.',
    wp2h:'Помогает с домашними заданиями', wp2p:'Ребёнок пишет своё задание — онлайн репетитор Орис объясняет как решить, не просто даёт ответ. Понимание остаётся.',
    ...
    ba2n:'Онлайн репетитор объяснил иначе — с карточками. Через неделю тема закрыта',
    ...
    g4h:'Пробный период', g4p:'14 дней бесплатно — убедитесь сами до оплаты',
    meth_tag:'Система обучения', meth_title:'Методология SmartSkola',
    meth_sub:'Не просто онлайн репетитор на базе ИИ. Полноценная система, которая ведёт ребёнка от незнания к результату — шаг за шагом.',
    ...
    st3h:'Объяснение шагами', st3p:'Онлайн репетитор объясняет так, как понимает именно этот ребёнок — с примерами из жизни, без скучных учебников.',
    ...
    trial_p:'Первые 14 дней — бесплатно. Первые уроки, помощь с ДЗ и полный доступ ко всем предметам вашего класса. Вы увидите результат до оплаты.',
    ...
    trial_ph:'ваш@email.ru', trial_btn:'Попробовать 14 дней бесплатно →', trial_note:'Без карты · Отмена в любое время · Данные защищены',
  ...
  uk: {
    ...
    what_tag:'Що це таке',
    what_title:'Розумний онлайн репетитор для вашої дитини — завжди поруч',
    what_sub:'SmartSkola — це не просто онлайн репетитор на базі ШІ. Це повноцінна система навчання за шкільною програмою Латвії, яка працює як персональний онлайн репетитор: пояснює, перевіряє, запам\'ятовує прогрес.',
    wp1h:'Онлайн репетитор на базі ШІ пояснює — як живий репетитор', wp1p:'Ставить запитання, пояснює покроково, підбирає приклади під конкретну дитину. Не з підручника — з життя.',
    wp2h:'Допомагає з домашніми завданнями', wp2p:'Дитина пише своє завдання — онлайн репетитор Оріс пояснює як вирішити, не просто дає відповідь. Розуміння залишається.',
    ...
    ba2n:'Онлайн репетитор пояснив інакше — з картками. Через тиждень тему закрито',
    ...
    g4h:'Пробний період', g4p:'14 днів безкоштовно — переконайтеся самі до оплати',
    meth_tag:'Система навчання', meth_title:'Методологія SmartSkola',
    meth_sub:'Не просто онлайн репетитор на базі ШІ. Повноцінна система, яка веде дитину від незнання до результату — крок за кроком.',
    ...
    st3h:'Пояснення покроково', st3p:'Онлайн репетитор пояснює так, як розуміє саме ця дитина — з прикладами з життя, без нудних підручників.',
    ...
    t2txt:'«Син бився з дробами два місяці. Я сам намагався пояснювати — не виходило. Репетитор онлайн €25/год. SmartSkola пояснила інакше — через 3 дні син все зрозумів. Оцінка: 4 → 7.»',
