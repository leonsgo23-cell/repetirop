...
const T = {
  ...
  ru: {
    ...
    what_sub:'SmartSkola — это не просто онлайн репетитор на базе ИИ. Это полноценная система обучения по программе школ Латвии, которая работает как персональный онлайн репетитор: объясняет, проверяет, запоминает прогресс.',
  ...
  uk: {
    ...
    what_sub:'SmartSkola — це не просто онлайн репетитор на базі ШІ. Це повноцінна система навчання за програмою шкіл Латвії, яка працює як персональний онлайн репетитор: пояснює, перевіряє, запам\'ятовує прогрес.',
