...
1. Якщо учень надіслав ФОТО — коротко перелічи що бачиш: "Бачу завдання 1 (скоротити дроби: а, б, в), завдання 2, ..." і запитай з чого почнемо
...
1. Если ученик прислал ФОТО — кратко перечисли что видишь: "Вижу задание 1 (сократить дроби: а, б, в), задание 2, ..." и спроси с чего начнём
...
1. Ja skolēns nosūtīja FOTO — īsi uzskaitī ko redzi: "Redzu 1. uzdevumu (saīsināt daļskaitļus: a, b, c), 2. uzdevumu, ..." un jautā ar ko sāksim
